<script lang="ts">
	...
	const requestSignup = async () => {
		...
		loading = true;
		const res = await fetch(`${api_url}/auth/up`, {
			method: 'POST',
			headers: {
...
<Card full={true} title="Sign up">
	<p>Sign up with Interact credentials</p>
	...
	<div class="button primary" on:click={requestSignup}>Sign Up</div>
	<Toast
		type="error"
		open={errorToast}
